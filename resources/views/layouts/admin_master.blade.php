...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/blogwebsite.css')}}">
    @yield('css')
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-3 bg-faded sidebar">
            <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.posts.all')}}">Show All Post</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.post.add')}}">Add New Post</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Show All Comments</a>
                </li>
            </ul>
        </nav>
